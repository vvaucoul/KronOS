...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/20 19:13:09 by vvaucoul          #+#    #+#             */
/*   Updated: 2022/10/21 12:50:08 by vvaucoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern int multiboot_init(uint32_t *mboot_ptr);
extern int multiboot_check(void);
extern bool multiboot_check_magic_number(unsigned long magic_number);

...
/*   Updated: 2022/11/17 14:11:08 by vvaucoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void display_kernel_memory_map(void)
{
    ...
    // /* Total */
    // kprintf("- " COLOR_YELLOW "Total Available" COLOR_END ": " COLOR_GREEN "0x%x " COLOR_END "(" COLOR_GREEN "%u" COLOR_END " KB)\n" COLOR_END, KMAP.available.length + KMAP.available_extended.length, (KMAP.available.length + KMAP.available_extended.length) / 1024);
}
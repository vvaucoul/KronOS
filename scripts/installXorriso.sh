...
#    Updated: 2022/09/03 21:32:55 by vvaucoul         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
printf "$_LWHITE- Check package $_LYELLOW[XORRISO]$_LWHITE      $_LYELLOW> $_END$_DIM$xorriso or latest version$_END$_LYELLOW <$_END\n"

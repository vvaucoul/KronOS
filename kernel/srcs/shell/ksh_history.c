...
/*   Updated: 2022/09/07 01:25:47 by vvaucoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ksh_add_line_history(const char *str)
{
    ...
    kmemcpy(ksh_history[__current_history_line], str, kstrlen(str));
...
void ksh_history_up(void)
{
    ...
    {
        const uint32_t __len = kstrlen(ksh_history[__current_history_selection]);
